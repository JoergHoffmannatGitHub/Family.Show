...
public partial class Merge : UserControl
{
    ...
    private void SavePerson()
    {
        ...
        if (p1 != null && p2 != null)
        {
            ...
            {
                p3.Story = new Story();
                string storyFileName = new StringBuilder(
                    App.ReplaceEncodedCharacters(p3.FullName + "(" + p3.Id + ")")).Append(".rtf").ToString();
    ...
    public bool CurrentPerson(int i)
    {
        ...
        OldCremationDate.Content = existingPerson.CremationDateDescriptor +
            existingPerson.CremationDate.ToShortString();
        ...
        //Tooltips
        string existingBirthCitation = citationString(
            existingPerson.BirthSource,
            existingPerson.BirthCitation,
            existingPerson.BirthCitationActualText,
            existingPerson.BirthCitationNote,
            existingPerson.BirthLink);
        string existingDeathCitation = citationString(
            existingPerson.DeathSource,
            existingPerson.DeathCitation,
            existingPerson.DeathCitationActualText,
            existingPerson.DeathCitationNote,
            existingPerson.DeathLink);
        string existingCremationCitation = citationString(
            existingPerson.CremationSource,
            existingPerson.CremationCitation,
            existingPerson.CremationCitationActualText,
            existingPerson.CremationCitationNote,
            existingPerson.CremationLink);
        string existingBurialCitation = citationString(
            existingPerson.BurialSource,
            existingPerson.BurialCitation,
            existingPerson.BurialCitationActualText,
            existingPerson.BurialCitationNote,
            existingPerson.BurialLink);
        string existingEducationCitation = citationString(
            existingPerson.EducationSource,
            existingPerson.EducationCitation,
            existingPerson.EducationCitationActualText,
            existingPerson.EducationCitationNote,
            existingPerson.EducationLink);
        string existingOccupationCitation = citationString(
            existingPerson.OccupationSource,
            existingPerson.OccupationCitation,
            existingPerson.OccupationCitationActualText,
            existingPerson.OccupationCitationNote,
            existingPerson.OccupationLink);
        string existingReligionCitation = citationString(
            existingPerson.ReligionSource,
            existingPerson.ReligionCitation,
            existingPerson.ReligionCitationActualText,
            existingPerson.ReligionCitationNote,
            existingPerson.ReligionLink);

        string newBirthCitation = citationString(
            newPerson.BirthSource,
            newPerson.BirthCitation,
            newPerson.BirthCitationActualText,
            newPerson.BirthCitationNote,
            newPerson.BirthLink);
        string newDeathCitation = citationString(
            newPerson.DeathSource,
            newPerson.DeathCitation,
            newPerson.DeathCitationActualText,
            newPerson.DeathCitationNote,
            newPerson.DeathLink);
        string newCremationCitation = citationString(
            newPerson.CremationSource,
            newPerson.CremationCitation,
            newPerson.CremationCitationActualText,
            newPerson.CremationCitationNote,
            newPerson.CremationLink);
        string newBurialCitation = citationString(
            newPerson.BurialSource,
            newPerson.BurialCitation,
            newPerson.BurialCitationActualText,
            newPerson.BurialCitationNote,
            newPerson.BurialLink);
        string newEducationCitation = citationString(
            newPerson.EducationSource,
            newPerson.EducationCitation,
            newPerson.EducationCitationActualText,
            newPerson.EducationCitationNote,
            newPerson.EducationLink);
        string newOccupationCitation = citationString(
            newPerson.OccupationSource,
            newPerson.OccupationCitation,
            newPerson.OccupationCitationActualText,
            newPerson.OccupationCitationNote,
            newPerson.OccupationLink);
        string newReligionCitation = citationString(
            newPerson.ReligionSource,
            newPerson.ReligionCitation,
            newPerson.ReligionCitationActualText,
            newPerson.ReligionCitationNote,
            newPerson.ReligionLink);

        BirthImage.ToolTip =
            Properties.Resources.ExistingCitation + " \n" +
