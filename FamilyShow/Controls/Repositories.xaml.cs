...
public partial class Repositories : UserControl
{
    ...
    private void Export()
    {
        ...
        if (!string.IsNullOrEmpty(dialog.FileName))
        {
            ...
            repostories.ExportRepositories(
                dialog.FileName,
                Path.GetFileName(_familyCollection.FullyQualifiedFilename),
                _repository);
        }
    ...
    private void Save()
    {
        if (RepositoriesCombobox.Items != null &&
            RepositoriesCombobox.Items.Count > 0 &&
            RepositoriesCombobox.SelectedItem != null)
        {
            Repository r = (Repository)RepositoriesCombobox.SelectedItem;
            ...
            RepositoriesCombobox.SelectedItem != null)
        {
            ...
            if (deletable == true)
            {
                MessageBoxResult result = MessageBox.Show(
                    Properties.Resources.ConfirmDeleteRepository,
                    Properties.Resources.Repository,
            ...
            {
                MessageBox.Show(
                    Properties.Resources.UnableDeleteRepository1 + " " +
                        repositoryToRemove.Id + " " +
                        Properties.Resources.UnableDeleteRepository2,
                    Properties.Resources.Repository,
                    MessageBoxButton.OK,
                    MessageBoxImage.Warning);
            }
