        ...
        if (Options() != "0") //only run if cancel not clicked
        {
            ...
            else
            {
                if (!string.IsNullOrEmpty(dialog.FileName))
                {
                    ...
                    if (Options() == "3")
                    {
                        // Export current person and immediate family relatives
                        html.ExportDirect(
                            _family,
                            _source,
                            _repository,
                    ...
                    MessageBoxResult result = MessageBox.Show(
                        Properties.Resources.SourcesExportMessage,
                        Properties.Resources.ExportResult,
