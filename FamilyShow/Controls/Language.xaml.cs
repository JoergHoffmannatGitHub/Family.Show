...
public partial class Language : UserControl
{
    ...
    // Using a DependencyProperty as the backing store for SelectedLanguage.
    ...
    {
        string languageCode = e.NewValue as string;
        if (languageCode != Properties.Settings.Default.Language)
        {
            ...
            MessageBox.Show(
                Properties.Resources.LanguageChangeMessage,
                Properties.Resources.LanguageHeader,
                MessageBoxButton.OK,
