...
public class HtmlExport
{
        ...
        foreach (Person p in peopleCollection)
        {
          if (!((p.IsLiving && privacy) || p.Restriction == Restriction.Private))
          {
            ...
            if (year >= i && year <= ii)
            {
              ...
              {
                _tw.WriteLine("<p class=\"event\"><b>" + p.FullName + "</b> " + Properties.Resources.WasBornOn + " " + DateWrapper.Format(p.BirthDate) + " " + Properties.Resources.In + " " + p.BirthPlace + ".</p>");
              }
              else
              {
                _tw.WriteLine("<p class=\"event\"><b>" + p.FullName + "</b> " + Properties.Resources.WasBornOn + " " + DateWrapper.Format(p.BirthDate) + ".</p>");
              }
            }
          }
        ...
        foreach (Person p in peopleCollection)
        {
          if (!((p.IsLiving && privacy) || p.Restriction == Restriction.Private))
          {
            ...
            if (year >= i && year <= ii)
            {
              ...
              {
                _tw.WriteLine("<p class=\"event\"><b>" + p.FullName + "</b> " + Properties.Resources.DiedOn + " " + DateWrapper.Format(p.DeathDate) + " " + Properties.Resources.In + " " + p.DeathPlace + ".</p>");
              }
              else
              {
                _tw.WriteLine("<p class=\"event\"><b>" + p.FullName + "</b> " + Properties.Resources.DiedOn + " " + DateWrapper.Format(p.DeathDate) + ".</p>");
              }
            }
            year = 0;
          }
        ...
        foreach (Person p in peopleCollection)
        {
          if (!((p.IsLiving && privacy) || p.Restriction == Restriction.Private))
          {
            ...
            if (year >= i && year <= ii)
            {
              ...
              {
                _tw.WriteLine("<p class=\"event\"><b>" + p.FullName + "</b> " + Properties.Resources.WasBuriedOn + " " + DateWrapper.Format(p.BurialDate) + " " + Properties.Resources.At + " " + p.BurialPlace + ".</p>");
              }
              else
              {
                _tw.WriteLine("<p class=\"event\"><b>" + p.FullName + "</b> " + Properties.Resources.WasBuriedOn + " " + DateWrapper.Format(p.BurialDate) + ".</p>");
              }
            }
            year = 0;
          }
        ...
        foreach (Person p in peopleCollection)
        {
          if (!((p.IsLiving && privacy) || p.Restriction == Restriction.Private))
          {
            ...
            if (year >= i && year <= ii)
            {
              ...
              {
                _tw.WriteLine("<p class=\"event\"><b>" + p.FullName + "</b> " + Properties.Resources.WasCrematedOn + " " + DateWrapper.Format(p.CremationDate) + " " + Properties.Resources.At + " " + p.CremationPlace + ".</p>");
              }
              else
              {
                _tw.WriteLine("<p class=\"event\"><b>" + p.FullName + "</b> " + Properties.Resources.WasCrematedOn + " " + DateWrapper.Format(p.CremationDate) + ".</p>");
              }
            }
            year = 0;
          }
  ...
  private static string dataWithoutNote(Person p, string[,] sourceArray, string relationship = null)
  {
    ...
    return "<tr id=\"id_" + p.Id + "\" class=\"person\">" + relationshipOutput + "<td>" + p.FirstName + "</td><td>"
      ...
      + p.BurialDateDescriptor + " " + DateWrapper.Format(p.BurialDate) + sourceArray[0, 5] + "</td><td>"
      + p.CremationPlace + sourceArray[0, 6] + "</td><td>"
      + p.CremationDateDescriptor + " " + DateWrapper.Format(p.CremationDate) + sourceArray[0, 6] + "</td><td></td></tr>";
  }
