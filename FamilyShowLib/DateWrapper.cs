...
public sealed class DateWrapper : IEquatable<DateWrapper>, IXmlSerializable
{
    ...
    public DateWrapper(int year, int month = 0, int day = 0) =>
        Date = Genealogy.Domain.ValueObjects.Date.Create(year, month, day);
    ...
    /// </summary>
    /// <param name="value">The <see cref="DateWrapper"/> to test.</param>
    /// <param name="dateExact">When this method returns, contains the exact date if the
    /// <see cref="DateWrapper"/> contains an exact date; otherwise, null.</param>
    ...
    public static bool operator ==(DateWrapper dateWrapper1, DateWrapper dateWrapper2) =>
        Equals(dateWrapper1, dateWrapper2);
