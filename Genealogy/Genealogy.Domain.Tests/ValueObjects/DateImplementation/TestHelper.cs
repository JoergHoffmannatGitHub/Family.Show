...
public static class TestHelper
{
    ...
    internal static void TestEqualsStruct<T>(T value, T equalValue, params T[] unequalValues)
    ...
    private static void TestObjectEquals(object value, object equalValue, params object[] unequalValues)
    {
        ...
        Assert.True(
            value.GetHashCode() == equalValue.GetHashCode(),
            "GetHashCode() for two different but equal objects");
    }
