...
public class SharedBirthdaysTest
{
    ...
    public void PeopleCollectionProperty_Changed_ShouldSetUpListCollectionView()
    {
      ...
      new Person("Jane", "Doe") { BirthDate = new(1990, 2, 2) }
        ...
        // Act
        SharedBirthdays.PeopleCollectionProperty_Changed(
            sharedBirthdays,
            new DependencyPropertyChangedEventArgs(SharedBirthdays.PeopleCollectionProperty, null, peopleCollection));
    ...
    public void GroupedListBox_SelectionChanged_ShouldRaiseEventWithCorrectBirthDate()
    {
        ...
        // Act
        sharedBirthdays.GroupedListBox_SelectionChanged(
            listBox, new SelectionChangedEventArgs(
                ListBox.SelectionChangedEvent, new List<object>(), new List<object> { person }));
