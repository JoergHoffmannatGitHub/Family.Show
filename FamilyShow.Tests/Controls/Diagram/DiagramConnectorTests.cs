...
public class DiagramConnectorTests
{
    ...
    private class TestMarriedDiagramConnector(
        bool married,
        DiagramConnectorNode startNode,
        DiagramConnectorNode endNode,
        DpiScale dpiScale) : MarriedDiagramConnector(married, startNode, endNode, dpiScale)
    {
